...
public class AdminController {
	 ...
	 * to show this page if the client is unauthorized and because the new object
	 * doesn't have an id. The hasPermission requires an existing id!
	 */
	@PreAuthorize("hasAuthority('ROLE_ADMIN')")
	@RequestMapping(value = "/add", method = RequestMethod.GET)
	public String getAdd(Model model) {
		logger.debug("Sanjeev Received request to show add page");
	...
	public String getDeletePage(@RequestParam(value = "id", required = true) Long id, Model model) {
