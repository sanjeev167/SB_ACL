...
import com.pvt.post.domain.PublicPost;
...
public class PublicService extends JdbcDaoSupport implements GenericService {

	protected static Logger logger = LoggerFactory.getLogger(PublicService.class);
	...
	public Boolean add(Post post) {
		try {
			...
			SimpleJdbcInsert simpleJdbcInsert = new SimpleJdbcInsert(dataSource).withTableName("public_post")
	...
	public Boolean edit(Post post) {
		try {
			...
			String updateSql = "update public_post set date = ?, " + "message = ? where id = ?";
