...
(function ($) {
    ...
    $.widget("jHtree.jHTree", {
        ...
        _constructTree: function (jsonStructureObject) {
            ...
            $tree.addClass('treeJh').append("<ul id='tremainul'>");
        ...
        _interactionEvents: function () {
            ...
            $(".treeJh").on('mouseleave', '.tnode', function () {
            ...
            $(".treeJh").on("click", ".trcont > .ui-widget-header", function () {
                $(this).parent().parent().find('.trchl').slideToggle('slow', "easeOutBounce", function () {
                    // Animation complete.
                });
            });

            $(".treeJh").on("click", "div[data-func]", function () {
                var objbtn = $(this);
                var objfocus = objbtn.parent().closest('li');
                var objother = objfocus.parent().find('> li');
                var targetobjs = $(objother).not(objfocus);
            ...
            $("#zmrslidr").slider({
                ...
                slide: function (event, ui) {
                    ...
                    if (brwstp == true) {
                        ...
                        $('.treeJh').css('MozTransform', 'scale(' + ui.value + ')');
                    } else {

                        $('.treeJh').css('zoom', ' ' + ui.value + '%');
                    }
                }
            });
