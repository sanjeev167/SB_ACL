						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" name="groupName"
									id="groupNameId" placeholder="Group Name">
								<span id="groupName_err" class="field-error"></span>
							</div>
						</div>
						
						<input hidden="true" name="id" id="groupRecordId" />
					</div>
					<!-- /.box-body -->
...
<script src="${contextPath}/resources/pagejs/appGroup.js"></script>
