	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary ">
				...
				<div class="box-body ">
					<table width="100%" id="appAdminUserId"
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" id="commonFormId" action="">
					<div class="box-body">
						...
						<input hidden="true" name="id" id="appAdminUserRecordId" />
					</div>
					<!-- /.box-body -->
...
<script src="${contextPath}/resources/pagejs/adminUser.js"></script>
