...
<section class="content-header">
	<h1>Manage Role's Group</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
		<li class="active">Role's Group</li>
	</ol>
</section>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary ">
				...
				<div class="box-body ">
					<table width="100%" id="appGroupRoleId"
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" id="commonFormId" action="">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="inputGroupName" class="col-sm-4 control-label">
								Group</label>
							<div class="col-sm-7">
						...
						<input hidden="true" name="id" id="appGroupRoleRecordId" />
					</div>
					<!-- /.box-body -->
...
<script src="${contextPath}/resources/pagejs/appGroupRole.js"></script>
