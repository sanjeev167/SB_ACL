...
<section class="content-header">
	<h1>Manage User Category</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
		<li class="active">Users Category</li>
	</ol>
</section>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary ">
				...
				<div class="box-body ">
					<table width="100%" id="userCategoryId"
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" id="commonFormId" action="">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="inputCategoryName" class="col-sm-4 control-label">
								Use-Category</label>
							<div class="col-sm-7">
								<input type="text" class="form-control" name="categoryName"
									id="categoryNameId" placeholder="User category name">
								<span id="categoryName_err" class="field-error"></span>
							</div>
						</div>
						
						<input hidden="true" name="id" id="categoryNameRecordId" />
					</div>
					<!-- /.box-body -->
...
<script src="${contextPath}/resources/pagejs/userCategory.js"></script>
