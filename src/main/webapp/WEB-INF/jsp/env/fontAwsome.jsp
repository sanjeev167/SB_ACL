...
<select class="form-control" name="imgUrl" id="imgUrlId">
	...
	<option value='fa-calendar-check-o'>&#xf274;
		fa-calendar-check-o</option>
	<option value='fa-calendar-minus-o'>&#xf272;
		fa-calendar-minus-o</option>
	<option value='fa-calendar-o'>&#xf133; fa-calendar-o</option>
	<option value='fa-calendar-plus-o'>&#xf271; fa-calendar-plus-o</option>
	<option value='fa-calendar-times-o'>&#xf273;
		fa-calendar-times-o</option>
	...
	<option value='fa-caret-square-o-down'>&#xf150;
		fa-caret-square-o-down</option>
	<option value='fa-caret-square-o-left'>&#xf191;
		fa-caret-square-o-left</option>
	<option value='fa-caret-square-o-right'>&#xf152;
		fa-caret-square-o-right</option>
	<option value='fa-caret-square-o-up'>&#xf151;
		fa-caret-square-o-up</option>
	...
	<option value='fa-chevron-circle-down'>&#xf13a;
		fa-chevron-circle-down</option>
	<option value='fa-chevron-circle-left'>&#xf137;
		fa-chevron-circle-left</option>
	<option value='fa-chevron-circle-right'>&#xf138;
		fa-chevron-circle-right</option>
	<option value='fa-chevron-circle-up'>&#xf139;
		fa-chevron-circle-up</option>
	...
	<option value='fa-drivers-license-o'>&#xf2c3;
		fa-drivers-license-o</option>
	...
	<option value='fa-google-plus-circle'>&#xf2b3;
		fa-google-plus-circle</option>
	<option value='fa-google-plus-official'>&#xf2b3;
		fa-google-plus-official</option>
	...
	<option value='fa-microphone-slash'>&#xf131;
		fa-microphone-slash</option>
	...
	<option value='fa-odnoklassniki-square'>&#xf264;
		fa-odnoklassniki-square</option>
	...
	<option value='fa-question-circle-o'>&#xf29c;
		fa-question-circle-o</option>
	...
	<option value='fa-share-alt-square'>&#xf1e1;
		fa-share-alt-square</option>
	...
	<option value='fa-sort-amount-desc'>&#xf161;
		fa-sort-amount-desc</option>
	...
	<option value='fa-sort-numeric-asc'>&#xf162;
		fa-sort-numeric-asc</option>
	<option value='fa-sort-numeric-desc'>&#xf163;
		fa-sort-numeric-desc</option>
	...
	<option value='fa-stumbleupon-circle'>&#xf1a3;
		fa-stumbleupon-circle</option>
	...
	<option value='fa-thermometer-empty'>&#xf2cb;
		fa-thermometer-empty</option>
	<option value='fa-thermometer-full'>&#xf2c7;
		fa-thermometer-full</option>
	<option value='fa-thermometer-half'>&#xf2c9;
		fa-thermometer-half</option>
	<option value='fa-thermometer-quarter'>&#xf2ca;
		fa-thermometer-quarter</option>
	<option value='fa-thermometer-three-quarters'>&#xf2c8;
	...
	<option value='fa-times-rectangle-o'>&#xf2d4;
		fa-times-rectangle-o</option>
	...
	<option value='fa-universal-access'>&#xf29a;
		fa-universal-access</option>
	...
	<option value='fa-volume-control-phone'>&#xf2a0;
	...
	<option value='fa-y-combinator-square'>&#xf1d4;
		fa-y-combinator-square</option>
