...
<section class="content-header">
	<h1>Manage Context-In-Application</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
		<li class="active">Context-In-Application</li>
	</ol>
</section>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary ">
				...
				<div class="box-body ">
					<table width="100%" id="departmentId"
				...
				<form class="form-horizontal" id="commonFormId" action="">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="inputDepartmentName" class="col-sm-5 control-label">
								App. Context</label>
							<div class="col-sm-7">
								<input type="select" class="form-control" name="departmentName"
									id="departmentNameId" placeholder="Application Context"> <span
									id="departmentNameId_err" class="field-error"></span>
							</div>
						</div>
						
						<input hidden="true" name="id" id="departmentRecordId" />
					</div>
					<!-- /.box-body -->
...
<script src="${contextPath}/resources/pagejs/department.js"></script>
