<ul class="nav navbar-nav">
				...
				<ul class="menu">
					<li>
						<!-- start message --> <a href="#">
							<div class="pull-left">
								<img
									src="${contextPath}/resources/assets/dist/img/user2-160x160.jpg"
	...
	<li class="dropdown user user-menu"><a href="#"
		class="dropdown-toggle" data-toggle="dropdown"> <img
			src="${contextPath}/resources/assets/dist/img/user2-160x160.jpg"
			class="user-image" alt="User Image"> <span class="hidden-xs">Sanjeev</span>
	</a>
		<ul class="dropdown-menu">
			<!-- User image -->
			<li class="user-header"><img
				...
				<p>
					Sanjeev - Admin <small>Member since Nov. 2012</small>
				</p></li>
			<!-- Menu Body -->
			<li class="user-body">
				<div class="row">
			...
			<li class="user-footer">
				...
				<div class="pull-right">
					<a href="/admin/doLogout" class="btn btn-default btn-flat">Sign
						out</a>
				</div>
			</li>
		</ul></li>
